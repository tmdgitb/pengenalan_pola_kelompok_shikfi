...
public class HistogramPreprocessActivity extends ActionBarActivity {
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HistogramPreprocessActivity.this);
    ...
    public void MakeHist(Bitmap img){
        ...
        blueSet.setAxisDependency(YAxis.AxisDependency.LEFT);
...
//        img.recycle();
    ...
    private void equalizeHist(){
        Intent i = new Intent(HistogramPreprocessActivity.this, HistogramEqActivity.class);
        i.putExtra("target_img", targetImgPath);
        startActivity(i);
    }

    private void correctGamma(){
        Intent i = new Intent(HistogramPreprocessActivity.this, GammaCorrActivity.class);
        i.putExtra("target_img", targetImgPath);
        startActivity(i);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_histogram_preprocess, menu);
        return true;
    }
